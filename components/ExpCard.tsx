...
const ExpCard = ({ experience }: Props) => {
  ...
  return (
    <motion.article
      ...
      className="flex flex-col rounded-lg justify-center items-center space-y-10 flex-shrink-0 w-full h-[650px] bg-[#292929] px-6 py-8 opacity-100 cursor-pointer transition-opacity duration-200 overflow-hidden"
    >
      <motion.div
